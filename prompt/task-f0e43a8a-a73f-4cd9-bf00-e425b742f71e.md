...
updated_at: '2026-06-06T17:39:44.192581+00:00'
target_files:
...
1. No function in the targeted route or service files exceeds 80 lines (excluding docstrings and comments).
2. No targeted file exceeds 500 lines.
3. Business logic is clearly separated from API request/response handling.
4. Code readability and maintainability are visibly improved.
