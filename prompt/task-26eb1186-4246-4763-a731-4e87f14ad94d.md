...
updated_at: '2026-06-13T20:15:54.314753+00:00'
target_files:
...
1. تمام مقادیر enumهای ریسک در بک‌اند و فرانت‌اند با حروف کوچک و یکسان هستند. _(verify: static)_
2. مقدار 'suspect' در فرانت‌اند با 'suspect' در بک‌اند مطابقت دارد. _(verify: static)_
3. نمودار ارتباطی و لیست اشخاص، رنگ‌ها و برچسب‌های ریسک را به‌درستی نمایش می‌دهند. _(verify: static)_
