...
updated_at: '2026-06-13T18:03:53.520324+00:00'
target_files:
...
1. A single `app.core.enums.py` file contains all shared enum definitions.
2. All backend modules import enums from `app.core.enums.py`.
3. No local enum definitions or fallback logic for shared enums exist outside `app.core.enums.py`.
4. All API endpoints and ORM operations correctly use the canonical enum values.
