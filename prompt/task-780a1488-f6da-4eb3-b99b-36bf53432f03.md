...
updated_at: '2026-06-13T18:04:48.168527+00:00'
target_files:
...
1. تمام توابع `_can_access_classification` محلی حذف شوند.
2. روت‌های API از `app.api.deps` یا متدهای مدل `User` برای کنترل دسترسی استفاده کنند.
3. تست‌های امنیتی برای اطمینان از عدم دسترسی کاربران با سطح محرمانگی پایین‌تر به محتوای طبقه‌بندی‌شده اضافه شود.
