...
updated_at: '2026-06-06T17:37:04.896246+00:00'
target_files:
- backend/app/main.py
---
...
1. لیست `allow_origins` در `CORSMiddleware` به صراحت فقط دامنه‌های فرانت‌اند مورد اعتماد را لیست می‌کند.
2. درخواست‌ها از مبدأهای نامعتبر توسط بک‌اند با خطای CORS مسدود می‌شوند.
3. برنامه فرانت‌اند می‌تواند با موفقیت تماس‌های API را به بک‌اند برقرار کند.
