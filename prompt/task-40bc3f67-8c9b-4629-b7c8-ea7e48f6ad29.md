...
updated_at: '2026-06-06T17:37:04.885415+00:00'
target_files:
...
1. هیچ کلید API حساس بک‌اند (مانند LLM، سرویس‌های OSINT) در باندل جاوااسکریپت سمت کلاینت یافت نمی‌شود.
2. تمام متغیرهای محیطی که در فرانت‌اند قابل دسترسی هستند، با پیشوند `NEXT_PUBLIC_` هستند.
3. فرانت‌اند با سرویس‌های حساس بک‌اند فقط از طریق API بک‌اند خود پروژه ارتباط برقرار می‌کند.
