...
updated_at: '2026-06-06T17:37:04.899725+00:00'
target_files:
- backend/app/main.py
...
1. تلاش برای ورود بیش از N بار در یک بازه M دقیقه‌ای منجر به پاسخ `429 Too Many Requests` می‌شود.
2. نقاط پایانی عمومی API دارای محدودیت نرخ معقولی هستند.
3. مستندات مربوط به محدودیت نرخ به‌روزرسانی شده است.
