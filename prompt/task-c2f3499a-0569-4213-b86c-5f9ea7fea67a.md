...
updated_at: '2026-06-06T17:37:04.888409+00:00'
target_files:
- backend/.env.example
---
...
1. The `backend/.env.example` file contains at least 5 distinct environment variables relevant to the project's stack.
2. Each variable has a clear comment or example value.
3. The project can be started successfully using a `.env` file based on `.env.example` (assuming valid credentials are provided).
