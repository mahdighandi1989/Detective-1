...
updated_at: '2026-06-06T17:38:35.740254+00:00'
target_files:
- README.md
---
...
1. فایل `LICENSE` در ریشه ریپازیتوری وجود دارد.
2. فایل `README.md` برای اشاره به مجوز انتخاب شده به‌روزرسانی شده است.
