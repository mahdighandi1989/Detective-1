...
updated_at: '2026-06-13T20:16:02.393600+00:00'
target_files:
...
1. فقط یک تعریف از `ClassificationLevel` (یا `ClearanceLevel`) در کل بک‌اند وجود دارد. _(verify: static)_
2. تمام ماژول‌ها از این تعریف واحد استفاده می‌کنند. _(verify: static)_
3. منطق RBAC و اعتبارسنجی طبقه‌بندی به‌درستی کار می‌کند. _(verify: static)_
