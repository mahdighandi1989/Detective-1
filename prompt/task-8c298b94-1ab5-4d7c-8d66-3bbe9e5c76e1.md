...
updated_at: '2026-06-06T17:37:41.175709+00:00'
target_files:
...
1. اجرای `alembic revision --autogenerate -m "Check for pending changes"` روی کدبیس فعلی یک اسکریپت مهاجرت خالی (یا فقط تغییرات مورد انتظار) تولید می‌کند.
2. یک تغییر جدید در مدل (مثلاً اضافه کردن یک ستون) به درستی یک اسکریپت مهاجرت تولید می‌کند که با موفقیت اعمال می‌شود.
