---
task_id: cde42ffb-747c-4c7b-932f-9232d80d816c
...
created_at: '2026-06-13T18:10:52.610880+00:00'
updated_at: '2026-06-13T20:19:30.311759+00:00'
target_files:
...
فیلد `reliability_score` در توضیحات به عنوان 'امتیاز قابلیت اطمینان داده‌های استخراج شده از این منبع برای یک مورد خاص' (for a specific case) ذکر شده است. اما این فیلد به عنوان یک ستون مستقیم در مدل `Source` تعریف شده است. این طراحی به معنای یک امتیاز قابلیت اطمینان کلی و عمومی برای منبع است که با نیاز 'مورد خاص' در تضاد است. اگر قابلیت اطمینان واقعاً وابسته به مورد خاصی (مثلاً یک مقاله یا شخص) باش

📁 file: backend/app/models/source.py (line 116)
...
- `backend/app/models/source.py:116`
...
## 🧪 دستورات اعتبارسنجی
- `python -m py_compile backend/app/models/source.py`
- `ruff check backend/app/models/source.py`
- `pytest -x`
