...
updated_at: '2026-06-06T17:46:20.968552+00:00'
target_files:
...
1. تمام مقادیر پیکربندی حساس از متغیرهای محیطی بارگذاری می‌شوند.
2. هیچ اسرار حساسی در `backend/app/core/config.py` یا هیچ فایل منبع دیگری hardcode نشده است.
3. برنامه در صورت عدم وجود متغیرهای محیطی حیاتی در محیط‌های تولید، با خطا مواجه می‌شود.
