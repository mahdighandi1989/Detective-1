...
updated_at: '2026-06-06T17:37:04.886738+00:00'
target_files:
...
1. تمام نقاط پایانی API در صورت لزوم به صراحت توسط وابستگی‌های RBAC محافظت می‌شوند.
2. کاربران با مجوزهای ناکافی هنگام تلاش برای دسترسی به منابع محافظت شده، پاسخ 403 Forbidden دریافت می‌کنند.
3. کاربران با مجوزهای صحیح می‌توانند به منابع محافظت شده دسترسی پیدا کنند.
4. تست‌های جدیدی برای تأیید RBAC برای نقاط پایانی کلیدی اضافه می‌شوند.
