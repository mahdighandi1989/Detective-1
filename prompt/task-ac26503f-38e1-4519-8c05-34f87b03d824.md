...
updated_at: '2026-06-06T17:38:35.747232+00:00'
target_files:
...
1. همه کوکی‌های مربوط به احراز هویت و نشست دارای پرچم‌های `HttpOnly` و `Secure` هستند (هنگام اجرا بر روی HTTPS).
2. جاوااسکریپت سمت کلاینت نمی‌تواند به این کوکی‌ها دسترسی پیدا کند.
3. کوکی‌ها از طریق HTTP ساده ارسال نمی‌شوند.
