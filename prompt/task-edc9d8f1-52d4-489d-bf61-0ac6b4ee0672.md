...
updated_at: '2026-06-13T17:56:24.284365+00:00'
target_files:
...
1. صفحات `/search` و `/risk-assessment` در فرانت‌اند قابل دسترسی هستند.
2. صفحهٔ جستجوی معنایی به `/api/encyclopedia/search` متصل شده و نتایج را نمایش می‌دهد.
3. صفحهٔ ارزیابی ریسک به `/api/risk` یا `/api/risk-assessments` متصل شده و امکان مشاهده/مدیریت ارزیابی‌ها را فراهم می‌کند.
