...
updated_at: '2026-06-06T17:39:01.329906+00:00'
target_files:
- backend/app/main.py
...
1. تمام نقاط پایانی API یک فرمت خطای JSON سازگار را برای خطاهای مورد انتظار (مثلاً 404، 400) و غیرمنتظره (مثلاً 500) برمی‌گردانند.
2. خطاهای حیاتی و استثناها با ردیابی پشته و زمینه مربوطه لاگ می‌شوند.
3. هیچ اطلاعات حساسی در پاسخ‌های خطا فاش نمی‌شود.
