---
task_id: aa4b7d0a-a83b-48d1-b939-565751d0e900
title: تناقض در اعلامیه مجوز پروژه
type: docs
priority: medium
...
created_at: '2026-06-13T18:15:53.876468+00:00'
updated_at: '2026-06-13T20:20:13.084629+00:00'
target_files:
- README.md
- pyproject.toml
---

# تناقض در اعلامیه مجوز پروژه

## Raw Idea

فایل `README.md` حاوی یک نشان «License: MIT» است، اما متن مقدماتی و فایل `pyproject.toml` به‌صراحت مجوز را «Proprietary» اعلام می‌کنند. این تناقض ابهاماتی را در مورد شرایط مجوز پروژه ایجاد می‌کند که برای انطباق قانونی و استفاده مجدد احتمالی بسیار مهم است. همچنین، عبارت «منبع‌باز (OSINT)» در README با ادعای «Proprietary» در تضاد است.
...
- `README.md:4-5` — نشان مجوز MIT در خط 4 و متن 'Proprietary' در خط 10 README و همچنین عبارت 'منبع‌باز (OSINT)' در خط 14.
  ```markdown
  [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
  ...
  ```
- `pyproject.toml:5` — اعلامیه مجوز در `pyproject.toml`.
  ```
  license = "Proprietary"
  ```
...
- [ ] اعلامیه مجوز در `README.md` و `pyproject.toml` سازگار است.
- [ ] مجوز مورد نظر پروژه (MIT یا Proprietary) به‌طور واضح و بدون ابهام بیان شده است.
- [ ] عبارت 'منبع‌باز' با مجوز انتخابی همخوانی دارد.
- [ ] هیچ تستی fail نمی‌شود (`npm run test` / `pytest`)
- [ ] linter بدون warning عبور می‌کند
- [ ] type-check موفق است (`tsc --noEmit` / `mypy`)

## 🪜 مراحل اجرایی پیشنهادی
1. مجوز پروژه را روشن و استاندارد کنید. اگر پروژه اختصاصی است، نشان مجوز MIT را حذف کنید. اگر قرار است MIT باشد، `pyproject.toml` و متن README را بر این اساس به‌روزرسانی کنید. همچنین، عبارت «منبع‌باز» را با دقت بررسی کنید تا با نوع مجوز انتخابی همخوانی داشته باشد.

## 💡 نمونه‌های قبل/بعد
**حذف نشان MIT در صورت اختصاصی بودن**
...
1. اعلامیه مجوز در `README.md` و `pyproject.toml` سازگار است. _(verify: static)_
2. مجوز مورد نظر پروژه (MIT یا Proprietary) به‌طور واضح و بدون ابهام بیان شده است. _(verify: static)_
3. عبارت 'منبع‌باز' با مجوز انتخابی همخوانی دارد. _(verify: static)_
