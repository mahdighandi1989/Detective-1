...
updated_at: '2026-06-13T17:57:16.683883+00:00'
target_files:
...
1. کامپوننت `Header` در `frontend/src/components/Header.tsx` پیاده‌سازی شده است.
2. هدر در تمام صفحات فرانت‌اند نمایش داده می‌شود.
3. لینک‌های ناوبری در هدر کار می‌کنند.
4. وضعیت احراز هویت کاربر در هدر نمایش داده می‌شود.
