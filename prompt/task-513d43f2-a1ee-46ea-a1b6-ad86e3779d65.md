---
task_id: 513d43f2-a1ee-46ea-a1b6-ad86e3779d65
...
created_at: '2026-06-13T18:15:55.583564+00:00'
updated_at: '2026-06-13T20:21:17.851414+00:00'
---
...
---
[scan #2 at 2026-06-13T18:15:55.658507+00:00]
## 📋 شرح
env var `API_V1_PREFIX` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.

## 🤔 چرا مهم است
یا (الف) reader حذف شده و باعث config drift می‌شود، یا (ب) leak اطلاعات حساس به repository است (مخصوصاً اگر secret است).

## 🔍 جزئیات
- علت: documented in .env.exampl
---
[scan #3 at 2026-06-13T18:15:55.694962+00:00]
## 📋 شرح
env var `APP_ENV` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.
...
---
[scan #4 at 2026-06-13T18:15:55.732076+00:00]
## 📋 شرح
...
---
[scan #5 at 2026-06-13T18:15:55.769408+00:00]
## 📋 شرح
env var `BACKEND_CORS_ORIGINS` در `.env`/config تعریف شده ولی در هیچ `os.getenv` یا `process.env` خوانده نمی‌شود.
...
---
[scan #6 at 2026-06-13T18:15:55.808698+00:00]
## 📋 شرح
