  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Risk level colors for threat classification
        risk: {
          clean: 'hsl(var(--risk-clean))',
          suspicious: 'hsl(var(--risk-suspicious))',
          infiltrator: 'hsl(var(--risk-infiltrator))',
          transformed: 'hsl(var(--risk-transformed))',
          unknown: 'hsl(var(--risk-unknown))',
        },
        // Classification levels for confidentiality
        classification: {
